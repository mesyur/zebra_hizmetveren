...
class Data {
  ...
  late final List<ChildCategories> childCategories;

  Data.fromJson(Map<String, dynamic> json){
    subCategories = List.from(json['subCategories']).map((e)=>SubCategories.fromJson(e)).toList();
    childCategories = List.from(json['childCategories']).map((e)=>ChildCategories.fromJson(e)).toList();
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['subCategories'] = subCategories.map((e)=>e.toJson()).toList();
    _data['childCategories'] = childCategories.map((e)=>e.toJson()).toList();
    return _data;
  }
}
